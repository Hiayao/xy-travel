...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const ChangeValue1 = (value: string): void => {
      console.log(
        "selected",
        String(value)[0] + String(value)[7],
        String(value)[String(value).length - 5] +
          String(value)[String(value).length - 4],
        value.length
      );
      ...
      if (value.length === 11) {
        data.flights = data.flights.filter((item: any) => {
          return (
            Number(String(value)[0] + String(value)[1]) < Number(item.depTimes[0]) &&
            Number(item.depTimes[7]) < Number(String(value)[7] + String(value)[8])
          );
        });
      }
       if (value.length === 13) {
        data.flights = data.flights.filter((item: any) => {
          return (
            Number(String(value)[0] + String(value)[1]) < Number(item.depTimes[0]) &&
            Number(item.depTimes[7]) < Number(String(value)[8] + String(value)[9])
          );
        });
      }
       if (value.length === 11) {
        data.flights = data.flights.filter((item: any) => {
          return (
            ...
            Number(item.depTimes[7]) < Number(String(value)[0])
          );
        });
      }
    };
