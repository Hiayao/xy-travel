  ...
  <div class="flex jc" style="margin-top:20px">
    <div class="hotelBox">
      ...
      <div class="flex" style="margin-top:20px">
        <a-input v-model:value="value" placeholder="Basic usage" style="width:20%;height: 42px;" />
        <a-range-picker v-model:value="value3" @change="onChange" style="width:30%;margin:0 10px;height: 42px;" />
