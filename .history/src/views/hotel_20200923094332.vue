        ...
        <div class="screenOne flex column jc">
          ...
          <div style="margin:8px 0px 10px">
            <a-select
              ...
              @change="ChangeOne"
            >
              <a-select-option :value="item.name" v-for="(item,index) in condition.levels" :key="index">{{item.name}}</a-select-option>
            </a-select>
          </div>
        </div>
        <div class="screenOne flex column jc">
          ...
          <div style="margin:8px 0px 10px" class="flex jsb">
            <a-select
              ...
              @change="ChangeTwo"
            >
              <a-select-option value="item.name" v-for="(item,index) in condition.types" :key="index">{{item.name}}</a-select-option>
            </a-select>
          </div>
        </div>
        <div class="screenOne flex column jc">
          ...
          <div style="margin:8px 0px 10px">
            <a-select
              ...
              @change="ChangeThe"
            >
              <a-select-option value="item.name" v-for="(item,index) in condition.assets" :key="index">{{item.name}}</a-select-option>
            </a-select>
          </div>
        </div>
        <div class="screenOne flex column jc">
          ...
          <div style="margin:8px 0px 10px">
            <a-select
              ...
              @change="ChangeFour"
            >
              <a-select-option value="item.name" v-for="(item,index) in condition.brands" :key="index">{{item.name}}</a-select-option>
            </a-select>
          </div>
        </div>
