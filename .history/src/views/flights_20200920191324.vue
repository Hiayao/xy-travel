      ...
      <div class="leftAll">
        ...
        <div v-for="(item,index) in flights" :key="index" class="flights">
          ...
          <div v-if="fleg === true && flag === index" class="down flex">
            ...
            <div>
              <div v-for="(item1,index1) in item.seat_infos" :key="index1" class="flex ac">
                <div class="flex ac" style="width:390px">
                  <div>{{item1.name}}</div>
                  <div class="xian"></div>
                  <div>{{item1.supplierName}}</div>
                </div>
                <div style="width:100px" class="flex ac jsb">
                  <div>￥ {{item1.settle_price}}</div>
                  <div>
