    ...
    <div class="fligthsBox flex jsb">
      <div class="leftAll">
        ...
        >
          ...
          <div v-if="item.check ===true" class="down flex">
              ...
              >
                ...
                <div style="width:165px" class="flex ac jsb">
                  ...
                  <div style="width:80px">
                    <a-button type="primary" size="small" @click="checkSure(item,item1)">选定</a-button>
      ...
      <div class="rightAll">
        ...
        <div class="rightTwo">
          ...
          <div v-for="(item,index) in history.slice(0,5)" :key="index" class="history_btn flex ac jsb">
            <div>
  ...
  setup(props, ctx: SetupContext) {
    ...
    const ChangeValue2 = (value: string): void => {
      ...
      data.flights = data.list.filter((item: any) => {
        return item.airline_name === value && item.org_airport_name === data.value;
      });
    };
    ...
    const checkSure = (item: any,item1: any): void => {
      console.log(item);
      console.log(item1);
      router.push({ path: "/air/order", query: { id: item.id, duration:JSON.stringify(item.duration),price: item1.par_price,setId: item1.seat_xid} });
    };
    onMounted(() => {
