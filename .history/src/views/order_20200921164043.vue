        ...
        <div class="Insurance">
          ...
          <!-- <div>
            <a-checkbox
              ...
              @change="onChange"
            >{{list.insurances[0].type}}: ￥{{list.insurances[0].price}}/份x1 最高赔付{{list.insurances[0].compensation}}</a-checkbox>
          </div>
          <div>
            <a-checkbox
              v-model:checked="checked"
              @change="onChange"
            >{{list.insurances[1].type}}: ￥{{list.insurances[1].price}}/份x1 最高赔付{{list.insurances[1].compensation}}元</a-checkbox>
          </div> -->
        </div>
      </div>
