    ...
    onMounted(() => {
      ...
      api.getPostAll().then((res: PostRes) => {
        ...
        data.postsList.map((item: any, index: number) => {
          if (index > 3) {
            item.images = ["https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1600270480715&di=81d25a5f08bf87f2712a430d7846339a&imgtype=0&src=http%3A%2F%2Fimages.669pic.com%2Felement_pic%2F3%2F88%2F77%2F52%2F63160fa6edcfde1b73bafadf9be77e8d.jpg"];
            // console.log(item1);
            // console.log(item);
          }
        });
