  ...
  <div class="post_All flex jc">
    <div class="postBox flex jsb">
      ...
      <div class="postRight">
        ...
        <div v-for="(item,index) in postsList.slice((pageNumber-1)*pageSize,pageSize)" :key="index" class="postsList">
          <div v-if="index%2===0">
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const onShowSizeChange = (current: number, pageSize: number): void => {
			...
			data.postsList=data.postsList.slice((data.pageNumber-1)*data.pageSize,data.pageSize)
		};
