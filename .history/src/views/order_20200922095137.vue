    ...
    <div class="orderBox flex jsb">
      <div class="BoxOne">
        <div class="onefoone">
          ...
          <a-form ref="ruleForms" :model="form" :rules="rules">
            <!-- <div style="margin-bottom:12px">乘机人</div> -->
            <a-form-item ref="passenger" label="乘机人" name="passenger">
              <a-input v-model:value="form.passenger" placeholder="请输入乘机人姓名" />
            </a-form-item>
            <!-- <div style="margin:12px 0 12px 0">证件类型</div> -->
            <a-form-item ref="certificates" label="证件类型" name="certificates">
              <a-input-group compact>
                ...
                <a-form-item ref="certificates" name="certificates">
                  <a-input style="width: 240%" v-model:value="form.certificates" placeholder="证件号码" />
                </a-form-item>
              </a-input-group>
            </a-form-item>
          </a-form>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const total: ComputedRef<number> = computed(
      () => data.price * 1 + data.audlet * 1 + 30 * data.num
    );
    return {
      ...toRefs(data),
      getAir,
