  ...
  <div class="flex jc" style="margin-top:20px">
    <div class="fligthsBox flex jsb">
      <div class="leftAll">
          ...
          <div class="flex ac jsb" style="width:520px">
            ...
            <div>
              <a-select
                ...
                @change="ChangeValue1"
              >
                <a-select-option value="" v-for="(item,index) in airTime" :key="index">{{item}}</a-select-option>
              </a-select>
            </div>
            <!-- 航空公司 -->
            <div>
              <a-select
                ...
                @change="ChangeValue2"
              >
                <a-select-option value="" v-for="(item,index) in airline" :key="index">{{item}}</a-select-option>
              </a-select>
            </div>
            <!-- 机型 -->
            <div>
        ...
        <div v-for="(item,index) in flights" :key="index" class="flights">
          ...
          <div v-if="fleg === true && flag === index" class="down flex">
            ...
            <div>
              <div v-for="(item1,index1) in item.seat_infos" :key="index1" class="seat_infos flex ac">
