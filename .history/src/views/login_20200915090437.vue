...
import { Rules,strpscript,validateVPassword } from "@/types/index";
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const handleClick = (): void => {
      ...
      api.getCaptchas(Number(data.form.tel)).then((res: any) =>{
        console.log(res);
    ...
    const validatePassword = (rule: any, value: any) => {
      ...
      if (value == "") message.success("密码不能为空！");
      else if (validateVPassword(value)) {
        message.success("密码格式有误！");
