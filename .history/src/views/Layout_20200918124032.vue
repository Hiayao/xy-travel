      ...
      <div class="top flex jsb ac">
        <div class="flex ac">
          ...
          <div
            ...
            :class="{'colour':fleg===index,'bgd':flag === path && flags === index}"
        ...
        <div class="login" @click="goLogin" v-if="user.nickname === ''">登录 / 注册</div>
          ...
          <a-popover>
            <template v-slot:content>
              <p
                ...
                :key="index"
                class="listItem"
                @click="choiceList(index)"
              >{{item}}</p>
            </template>
            <div class="user flex ac" @click="user">
              <img
        ...
        <div class="btOne flex">
          <div class="oneLeft flex jsb">
            <div v-for="(item,index) in linkList" :key="index" class="Listone">
              ...
              <div>
                <div
                  v-for="(item1,index1) in item.itemOne"
                  :key="index1"
                  class="itemOne"
                  v-html="item1"
                ></div>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
      ...
      linkList: [
        {
          ...
          itemOne: [
            "上亿旅行者共同打造的旅行神器",
            "<span style='color:orange;'>60,000</span> 多个全球旅游目的地",
            "<span style='color:orange;'>600,000</span> 个细分目的地新玩法",
            "<span style='color:orange;'>760,000,000</span> 次攻略下载",
            "<span style='color:orange;'>38,000</span> 家旅游产品供应商",
          ],
        },
        {
          title: "关于我们",
    ...
    const choiceList = (index: number): void => {
      if (index === 1) {
