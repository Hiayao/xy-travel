              ...
              item.depTimes.map((item2: any) => {
                if (Number(item.depTimes[1]) < Number(item.arrTimes[1])) {
                  data.duration[1] = String(
                    Number(item.depTimes[1]) - Number(item.arrTimes[1])
                  );
                  data.duration[0] = String(
                    Number(item.depTimes[0]) - Number(item.arrTimes[0])
                  );
                }
                if (Number(item.depTimes[1]) >= Number(item.arrTimes[1])) {
                  data.duration[1] = String(
                    Number(item.depTimes[1]) - Number(item.arrTimes[1]) + 60
                  );
                  data.duration[0] = String(
                    Number(item.depTimes[0]) - Number(item.arrTimes[0]) - 1
                  );
                }
              });
            });
