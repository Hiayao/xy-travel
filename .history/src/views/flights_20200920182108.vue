  ...
  <div class="flex jc" style="margin-top:20px">
    <div class="fligthsBox flex jsb">
      <div class="leftAll">
        ...
        <div v-for="(item,index) in flights" :key="index" class="flights flex jsb">
          <div class="airline_name flex column jc ac">
