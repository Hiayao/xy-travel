          ...
          <div class="flex ac jsb" style="width:520px">
            ...
            <div>
              <a-select
                ...
                @change="ChangeValue1"
              >
                <a-select-option v-for="(item,index) in airTime" :key="index">{{item}}</a-select-option>
              </a-select>
            </div>
            <!-- 航空公司 -->
            <div>
              <a-select
                ...
                @change="ChangeValue2"
              >
                <a-select-option v-for="(item,index) in airline" :key="index">{{item}}</a-select-option>
              </a-select>
            </div>
            <!-- 机型 -->
            <div>
              <a-select
                ...
                @change="ChangeValue3"
              >
                <a-select-option v-for="(item,index) in planeSize" :key="index">{{item}}</a-select-option>
              </a-select>
            </div>
          </div>
        </div>
        ...
        <div v-for="(item,index) in flights.slice((pageNumber-1)*pageSize,pageNumber*pageSize)" :key="index" class="flights">
          <div class="flex jsb ac" @click="choice(index)">
            <div class="airline_name flex ac">
              <div style="margin-rigth:5px">{{item.airline_name}}</div>
