  ...
  <div class="home_All flex jc">
    <div class="home pore">
      ...
      <div class="search poab">
        ...
        <div class="pore">
          <input v-model="value" :placeholder="values" @keydown.enter="pressEnter" class="input" />
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const onSearch = (): void => {
      ...
      if (data.fleg === 0) {
        router.push({ path: "/post", query: { keyword: data.value } });
      }
      if (data.fleg === 1) {
        router.push({ path: "/hotel", query: { keyword: data.value } });
      }
      // api
    ...
    const pressEnter = (e: any): void => {
      ...
      if (data.fleg === 0) {
        router.push({ path: "/post", query: { keyword: e.target.value } });
      }
      if (data.fleg === 1) {
        router.push({ path: "/hotel", query: { keyword: e.target.value } });
      }
      // api
      //   .getCities(data.value)
      //   .then((res) => {
