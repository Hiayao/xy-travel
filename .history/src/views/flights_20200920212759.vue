  ...
  <div class="flex jc" style="margin-top:20px">
    <div class="fligthsBox flex jsb">
      <div class="leftAll">
          ...
          <div class="flex ac jsb" style="width:520px">
            ...
            <div>
              <a-select
                ...
                @change="ChangeValue3"
              >
                <a-select-option :value='item' v-for="(item,index) in planeSize" :key="index">{{item}}</a-select-option>
              </a-select>
            </div>
          </div>
        </div>
        ...
        <div v-for="(item,index) in flights.slice((pageNumber-1)*pageSize,pageNumber*pageSize)" :key="index" class="flights">
          <div class="flex jsb ac" @click="choice(index)">
          ...
          <div v-if="fleg === true && flag === index" class="down flex">
              ...
              >
                ...
                <div style="width:165px" class="flex ac jsb">
                  ...
                  <div style="width:80px">
                    <a-button type="primary" size="small">选定</a-button>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const ChangeValue1 = (value: string): void => {
      console.log('selected',String(value)[0]+String(value)[1],String(value)[String(value).length-5]+String(value)[String(value).length-4],value.length);
      // data.flights = data.flights.filter((item: any) =>{
      //   return item.org_airport_name === value
      // })
  // if(value.length)
      // data.flights.map((item: any)=>{
      // if(Number(String(value)[0])<Number(item.depTimes[0])&&Number(item.depTimes[0])<Number(String(value)[0])){
