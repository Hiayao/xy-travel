  ...
  <div class="flex jc" style="margin-top:5px">
    <div class="orderBox flex jsb">
      <div class="BoxOne">
        ...
        <div class="Insurance">
          <div>保险</div>
          <a-checkbox v-model:checked="checked" @change="onChange" v-for="(item,index) in list.insurances" :key="index">{{item.type}}: ￥{{item.price}}/份x1 最高赔付{{item.compensation}}</a-checkbox>
        </div>
      </div>
